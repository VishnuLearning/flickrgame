var gameBoard = {
    ...
    dragDrop: function (event) {
        ...
        var $current = // select li element with data-value of current contained in element with id 'grid'
        var $dragged = // select li element with data-value of gameBoard.dragged contained in element with id 'grid'
        ...
        if (dragged_pos == current_pos - 1) {
            ...
            if (current_pos == game.gridSize * game.gridSize - 1) {
                $temp = // previous node of $current
                // insert $current before $dragged

                // insert $dragged after $temp

            } else {
                $temp = //next node of $current
                // insert $current before $dragged
    ...
    createGrid: function (aspect, imageUrl) {
        ...
        */
        ...
        var cellWidth = //width of each cell in pixels
        var cellHeight = //height of each cell in pixels
        var percentage = //how much % of width/height of original image should show in each cell
        ...
        for (var i = 0; i < game.gridSize * game.gridSize; i++) {
            ...
            var xpos = //x-position in %units;
            var ypos = //y-position in %units;
            var li = /*create new li element using jQuery syntax
